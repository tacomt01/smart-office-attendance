...
<template>
  <div class="p-4 md:p-8 max-w-7xl mx-auto space-y-7">
    <div class="flex items-center justify-between">
      <h1 class="font-display text-3xl font-semibold tracking-wide text-accent">{{ t('dashboard_title') }}</h1>
    ...
    <template v-else>
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 stagger">
        <div class="bg-dark-800 rounded-2xl p-5 border border-dark-700 border-l-4 shadow-sm border-l-[#6f9e87] card-hover animate-fadeInUp relative overflow-hidden">
        ...
        <div class="bg-dark-800 rounded-2xl p-5 border border-dark-700 border-l-4 shadow-sm border-l-[#d9a84e] card-hover animate-fadeInUp relative overflow-hidden">
        ...
        <div class="bg-dark-800 rounded-2xl p-5 border border-dark-700 border-l-4 shadow-sm border-l-[#cf8a63] card-hover animate-fadeInUp relative overflow-hidden">
        ...
        <div class="bg-dark-800 rounded-2xl p-5 border border-dark-700 border-l-4 shadow-sm border-l-[#cf6f72] card-hover animate-fadeInUp relative overflow-hidden">
        ...
        <div class="bg-dark-800 rounded-2xl p-5 border border-dark-700 border-l-4 shadow-sm border-l-[#b97aa0] card-hover animate-fadeInUp relative overflow-hidden">
        ...
        <div class="bg-dark-800 rounded-2xl p-5 border border-dark-700 border-l-4 shadow-sm border-l-[#8a8fc4] card-hover animate-fadeInUp relative overflow-hidden">
