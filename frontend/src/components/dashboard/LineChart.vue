...
const chartOptions = {
  ...
  plugins: {
    legend: { position: 'bottom' as const, labels: { color: '#8893a8', usePointStyle: true, padding: 16 } },
  },
  scales: {
    x: { ticks: { color: '#8893a8' }, grid: { color: 'rgba(120,130,150,0.18)' } },
    y: { ticks: { color: '#8893a8', stepSize: 1 }, grid: { color: 'rgba(120,130,150,0.18)' }, beginAtZero: true },
  },
};
</script>
...
<template>
  <div class="bg-dark-800 border border-dark-700 rounded-2xl p-6 shadow-sm">
    <h3 class="font-display text-base font-semibold text-slate-300 mb-4 tracking-wide">{{ t('chart_line_title') }}</h3>
    <div class="h-72">
